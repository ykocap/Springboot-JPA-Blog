...
<div class="container">
	<form action="/auth/loginProc" method="post">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=b55f69560154b966e8fdb26e5845aa9e&redirect_uri=http://localhost:8080/auth/kakao/callback"><img height="38px"
